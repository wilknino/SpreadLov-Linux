...
export default function VerifyEmailPage() {
  ...
  const verifyMutation = useMutation({
    ...
    onSuccess: (data) => {
      // Update user data in query client without page reload
      ...
      // Banner will disappear automatically since user.emailVerified is now true
      // Stay on current page (Discover) - banner will disappear
    },
    onError: (error: Error) => {
      toast({
